...
> (이 폴더는 이관 시점 스냅샷이며 더 이상 갱신되지 않습니다.)
...
| 추출된 포즈 스켈레톤 | 발레리나 | 노년 남성 | 로봇 |
|---|---|---|---|
| ![포즈 스켈레톤](samples/pose_01.png) | ![발레리나](samples/output_01.png) | ![노년 남성](samples/output_02.png) | ![로봇](samples/output_03.png) |
